...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  translations = {
    en: {
      ...
      gameVictorySubtitle: 'You made it out alive!',
      ...
      servicesIntro: 'I create responsive, high-performance websites tailored to your business. You purchase and own your domain name; I take care of everything else. Once the website is live, hosting is free, with no recurring fees, subject to Google Firebase\'s terms and conditions.',
      starterTitle: 'Starter',
      starterPrice: '€1000 VAT incl.',
      starter1: 'One-page template',
      starter2: 'Basic content',
      starter3: 'Mobile optimisation',
      starter4: 'Hosting setup',
      starter5: 'Basic performance optimisation',
      starter6: 'Ideal for small businesses',
      starter7: 'Delivery in 5 days',
      starter8: 'Deployment to Firebase- free, subject to Google\'s terms of use.',
      ...
      standard7: 'Deployment to Firebase- free, subject to Google\'s terms of use',
    ...
    fr: {
      ...
      gameVictorySubtitle: 'Tu t\'es échappé!',
      ...
      servicesIntro: 'Je crée des sites web responsives et performants, entièrement adaptés à votre activité. Vous achetez et possédez votre nom de domaine; je m\'occupe du reste. Une fois le site en ligne, l\'hébergement est gratuit, sans frais récurrents, sous réserve des conditions d\'utilisation de Google Firebase.',
      ...
      starter4: 'Configuration de l’hébergement',
      ...
      premium8: 'Déploiement sur Firebase- gratuit, sous réserve des conditions d\'utilisation de Google',
      maintenanceTitle: 'Gestion et maintenance mensuelles à la demande- interventions ponctuelles, facturées à l\'unité.',
      maintenanceIntro: 'Gardez votre site à jour et performant, quand vous en avez besoin.',
    ...
    de: {
      ...
      gameVictorySubtitle: 'Du du bist entkommen!',
      ...
      servicesIntro: 'Ich erstelle responsive, leistungsstarke Websites, die genau auf Ihr Unternehmen zugeschnitten sind. Sie kaufen und besitzen Ihren eigenen Domainnamen; ich kümmere mich um den Rest. Sobald die Website online ist, ist das Hosting kostenlos und es fallen keine wiederkehrenden Gebühren an, vorbehaltlich der Nutzungsbedingungen von Google Firebase.',
      ...
      starter8: 'Deployment auf Firebase- kostenlos, vorbehaltlich der Nutzungsbedingungen von Google.',
      standardTitle: 'Standard',
      ...
      standard7: 'Deployment auf Firebase- kostenlos, vorbehaltlich der Nutzungsbedingungen von Google.',
      premiumTitle: 'Premium',
      ...
      premium8: 'Deployment auf Firebase- kostenlos, vorbehaltlich der Nutzungsbedingungen von Google.',
      maintenanceTitle: 'Monatliche Wartung und Website-Betreuung nach Bedarf- einzelne, punktuelle Einsätze, die jeweils separat berechnet werden.',
      maintenanceIntro: 'Halten Sie Ihre Website aktuell und leistungsstark- genau dann, wenn Sie es brauchen.',
      maintenanceStarter: 'Starter',
